...
title: |
  [ECON-S307:  
  Séminaire d'économie appliquée - Prix](https://brownowen.github.io/ECONS307slides)
subtitle: "Séance d'introduction" 
author: "Michele Cincera - Owen Brown"
date: today
...
Chaque groupe doit rédiger en français un projet de 15 pages (appendix
et références exclues - taille de police 12). Le projet doit prendre la
forme suivante :

:::: incremental
::: {style="line-height:1"}
0.  **Page de garde** - titre, noms, matricules
1.  **Revue de littérature** - synthèse de la recherche relative à votre
    bien
2.  **Discussion de la source de données** - justification,
    fiabilité,méthode de récolte
3.  **Analyse descriptive des données** - sommaire des variables,
    graphiques, tables
4.  **Méthode, résultats, discussion** - spécification de la régression
    hédonique, estimation de modèle, discussion des résultats, liens
    contextuels
...
-   En indiquant votre numéro de groupe et vos noms (de famille) par
    ordre alphabétique, vous nommerez votre le fichier de votre travail
    :

::: {style="text-align: center"}
"\[GRP\_\] - Séminaire d'économie appliquée
(Prix)\_NOM_1-NOM_2-NOM_3.pdf".
:::
::::
:::::
...
::::: noincremental
:::: {style="line-height:1"}
-   Vous devrez également soumettre votre jeu de données, de **min 1000
    observations** ainsi que votre code.
-   **Il est impératif que le code que vous communiquez produise
    exactement les mêmes résultats que votre travail.**
-   Votre code devra être commenté. Chaque étape clé devra être
    clairement indiquée et brièvement décrite.

::: {style="text-align: center"}
"\[GRP\_\] - Code_NOM_1-NOM_2-NOM_3.R" <br> "\[GRP\_\] -
Dataset_NOM_1-NOM_2-NOM_3.csv"
:::
::::
:::::
...
::: incremental
-   **1er mars - 23h59** : Remettre une note dans laquelle vous
    expliquez quel bien vous souhaitez analyser et expliquez comment
    vous construirez un jeu de données (1 page max).

    <center>*\[GRP\_X\] - Note 1 (Prix)\_NOM_1-NOM_2-NOM_3.pdf*</center>

-   **15 mars - 23h59** : Remettre une note dans laquelle vous expliquez
    votre avancée de récolte de données - Méthode employée, source,
    quantité de données, objectifs (2 pages max).

    <center>*\[GRP\_X\] - Note 2 (Prix)\_NOM_1-NOM_2-NOM_3.pdf*</center>
...
-   La séance de présentation de projets aura lieu le **samedi 9 mai, de
    9h à 13h**. Tous les groupes devront être présents lors de la
    séance.
-   Chaque groupe présentera et défendra oralement en **10 minutes**.\
-   Chaque groupe aura à lire le projet d'un autre groupe et à poser une
    question sur le fond de leur projet. Votre question devra être
    critique, précise et constructive.
-   La note finale sera construite à hauteur de :
    -   60% pour le travail final
    -   30% pour la présentation et les réponses aux questions
    -   10% pour la question posée à l'autre groupe

## Utilisation d'intelligence artificielle générative

<br>

L'utilisation d'IA générative est autorisé. Néanmoins, cette utilisation
est soumise à deux conditions:

-   Il est interdit d'utiliser l'IA pour rédiger votre texte. Tout
    travail comportant du texte généré par IA sera pénalisé.
-   Votre annexe comprendra une section dans laquelle vous expliquerez
    [précisément]{.underline} quelle partie de votre travail a bénéficié
    de l'usage d'IA et comment elle en a bénéficié.
-   Vous devez évidemment être aptes à défendre le projet dans son intégralité, en ce compris votre code.
...
## Rappel - L'économétrie @wooldridge
...
de mesure ? Comparons l'hétéroscédasticité ($\sigma^2$) des deux
modèles:
...
::::: columns
::: column
![](images/Screen%20Shot%202026-02-02%20at%2023.42.19.png){width="130%"}
:::

::: column
![](images/Capture%20d’écran%202026-02-02%20234320.png){.lightbox
width="70%"}
:::
:::::
...
-   Vous êtes libres d'utiliser le logiciel statistique que vous
    préférez... mais choisissez-le bien !

-   Une séance pourra être organisée pour introduire l'utilisation de
    `R` ainsi que les bonnes pratiques d'usage ainsi qu'une guidance
    pour d'éventuelles questions.

-   Mobilisez vos connaissances d'autres cours ! **cf.** *Méthode et
    modélisation économique* & *Introduction à l'économétrie*
:::

## Pratiques de rédaction

- Pas de captures d'écran, exportez vos tables  :

::::: columns
::: column
![](images/screenreg.png){fig-align="center" width="100%"}
:::

::: column
![](images/cleanscreenreg.png){fig-align="center" width="80%" .border}
:::
:::

. . . 

- Rédigez proprement vos modèles:
$$ prix_{i,m} = \alpha_0 + \gamma_{m} + \beta_1\cdot poids_i + \beta_2 \cdot stockage_{i} \tag{1} $$
La plupart des logiciels de traitement de texte propose d'insérer des équations.

## Prochaines échéances

::: incremental
-   **1er mars - 23h59** : Remettre une note (1 page max) dans laquelle
    vous expliquez quel bien vous souhaitez analyser et expliquez
    comment vous construirez un jeu de données.

    ::: {style="text-align: center"}
    *\[GRP\_X\] - Note 1 (Prix)\_NOM_1-NOM_2-NOM_3.pdf*
    :::
...
-   **15 mars - 23h59** : Remettre une note dans laquelle vous expliquez
    ...
    ::: {style="text-align: center"}
    *\[GRP\_X\] - Note 2 (Prix)\_NOM_1-NOM_2-NOM_3.pdf*
    :::
:::
...
/!\\ Si vous exploitez une base de données que vous n'avez pas
constituée vous-mêmes, il est exigé de référencer dûment les auteurs et
autrices du jeu de données en les citant.

:::: noincremental
::: {style="line-height:1"}
-   [Tutoriel vidéo d'installation R &
    Rstudio](https://www.youtube.com/watch?v=hhqhyexDrsg)
-   [Tutoriel d'installation
    Pycharm](https://www.jetbrains.com/help/pycharm/installation-guide.html#toolbox)
-   [Tutoriel vidéo d'utilisation Selenium
    (Webscraping)](https://www.youtube.com/watch?v=tnrsSJ17ei8)
:::
::::
